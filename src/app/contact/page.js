...
export default function Contact() {
  ...
  const inputFocus = theme === "dark" ? "focus-visible:ring-blue-500" : "focus-visible:ring-blue-600";
  const labelColor = theme === "dark" ? "text-slate-400" : "text-gray-500";
  const badgeBg = theme === "dark" ? "bg-slate-800 border-slate-700 text-slate-300" : "bg-white border-gray-200 text-gray-700";
    ...
    <div className={`min-h-screen ${bgMain} transition-colors duration-300`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-[1.4fr_1fr] gap-8">
          {/* Left Column - Form */}
          <div>
            <span className={`inline-flex items-center gap-1.5 ${badgeBg} border rounded-full px-2.5 py-1 text-xs transition-colors duration-300`}>
              Get in touch
            </span>
            <h1 className={`text-3xl sm:text-4xl font-semibold tracking-tight ${textPrimary} transition-colors duration-300`}>
              We'd love to hear from you.
            </h1>
            <p className={`mt-3 text-sm ${textSecondary} max-w-md transition-colors duration-300`}>
              Whether you have a question, feedback, or a partnership idea —
              send us a note.
            </p>
          ...
          <div className="space-y-4">
            {[
              ...
              >
                <div className="flex items-start gap-3">
                  <div className={`w-9 h-9 rounded-lg ${iconBg} flex items-center justify-center transition-colors duration-300`}>
                  ...
                  <div>
                    ...
                    <p className={`text-sm ${textPrimary} mt-0.5 font-medium transition-colors duration-300`}>
                      {value}
                    </p>
                  </div>
                </div>
            ...
            {/* Emergency Hotline */}
            <div className={`${emergencyBg} rounded-xl p-5 transition-colors duration-300`}>
              <span className="inline-flex items-center gap-1.5 bg-white/10 border border-white/20 text-white rounded-full px-2.5 py-1 text-xs font-medium mb-3">
            ...
            <div className={`${bgCard} border ${cardBorder} rounded-xl p-5 transition-colors duration-300`}>
              <h4 className={`text-xs font-semibold ${textSecondary} uppercase tracking-wider mb-3`}>
                Working Hours
              </h4>
              <div className="space-y-1.5">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-emerald-500 dark:text-emerald-400 font-medium">Closed</span>
                </div>
              </div>
            </div>
          </div>
