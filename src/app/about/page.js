...
export default function About() {
  ...
  const badgeBg = theme === "dark" ? "bg-blue-950/30 text-blue-400" : "bg-blue-50 text-blue-600";
  ...
  const ctaBg = theme === "dark" ? "bg-slate-900 border-slate-800" : "bg-white border-gray-200";
  ...
  return (
    <div className={`min-h-screen ${bgMain} transition-colors duration-300`}>
      ...
      <section className={`border-b ${divider} transition-colors duration-300`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <span className={`inline-flex items-center gap-1.5 ${badgeBg} rounded-full px-3 py-1 text-xs font-medium mb-4 transition-colors duration-300`}>
              <Sparkles className="w-3 h-3" /> Our mission
            </span>
            <h1 className={`text-3xl sm:text-5xl font-semibold tracking-tight ${textPrimary} leading-tight transition-colors duration-300`}>
              We're rebuilding healthcare to feel like care again.
            </h1>
            <p className={`mt-5 text-base ${textSecondary} leading-relaxed transition-colors duration-300`}>
              Healthcare has spent decades getting more powerful and more
              confusing — at the same time. MediCare Connect exists to put
              clarity back at the center of the experience for both patients and
              providers.
      ...
      {/* ===== STATS SECTION ===== */}
      <section className={`${bgAlt} border-b ${divider} transition-colors duration-300`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid md:grid-cols-3 gap-4">
            {[
              { label: "Patients served", value: "10,000+" },
              ...
              >
                ...
                <p className={`mt-2 text-3xl font-semibold tracking-tight ${textPrimary} transition-colors duration-300`}>
                  {value}
                </p>
              </div>
            ))}
      ...
      <section className={`border-b ${divider} transition-colors duration-300`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <h2 className={`text-2xl sm:text-3xl font-semibold tracking-tight ${textPrimary} transition-colors duration-300`}>
            What we believe
          </h2>
          <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              >
                <div className={`w-9 h-9 rounded-lg ${iconBg} flex items-center justify-center mb-3 transition-colors duration-300`}>
                  <Icon className={`w-4 h-4 ${iconColor}`} />
                </div>
                <h3 className={`text-sm font-semibold ${textPrimary} transition-colors duration-300`}>{title}</h3>
                <p className={`text-sm ${textSecondary} mt-1 leading-relaxed transition-colors duration-300`}>
                  {desc}
                </p>
              </div>
            ))}
      ...
      <section className={`${bgAlt} transition-colors duration-300`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className={`${ctaBg} border ${cardBorder} rounded-2xl p-8 sm:p-12 transition-colors duration-300`}>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className={`text-2xl sm:text-3xl font-semibold tracking-tight ${textPrimary} transition-colors duration-300`}>
                  Ready to experience it?
                </h2>
                <p className={`text-sm ${textSecondary} mt-3 leading-relaxed transition-colors duration-300`}>
                  Create your account and book your first appointment in less
                  than two minutes.
                </p>
              ...
              <div className={`space-y-2 text-sm ${ctaText} transition-colors duration-300`}>
                {[
                  "Same-day appointments where available",
                  "Stripe-secured consultation payments",
                  "Records that follow you across providers",
