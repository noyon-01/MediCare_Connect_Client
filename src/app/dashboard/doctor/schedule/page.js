...
export default function DoctorSchedule() {
  ...
  const removeBtnHover = theme === "dark" ? "hover:bg-slate-700" : "hover:bg-gray-100";
  const removeBtnText = theme === "dark" ? "text-slate-400 hover:text-slate-300" : "text-gray-400 hover:text-gray-900";
  const slotItemBg = theme === "dark" ? "bg-slate-800 border-slate-700" : "bg-gray-50 border-gray-200";
  const slotText = theme === "dark" ? "text-slate-300" : "text-gray-700";
  const slotRemoveHover = theme === "dark" ? "hover:bg-red-950/30 hover:border-red-800" : "hover:bg-red-50 hover:border-red-100";
  ...
  if (!doctorProfile) {
    return (
      <div className={`${errorBg} border rounded-xl p-4 text-sm max-w-xl mx-auto transition-colors duration-300`}>
        Please complete your onboarding profile on the Dashboard home page first.
      </div>
    );
  }
  ...
  return (
    <div className={`space-y-6 max-w-4xl mx-auto ${bgMain} transition-colors duration-300`}>
      {/* Title */}
      <div>
        ...
        <div className={`${bgCard} border ${cardBorder} rounded-xl p-6 flex flex-col justify-between transition-colors duration-300`}>
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {days.length === 0 && (
                <p className={`text-xs ${emptyText} italic p-2 transition-colors duration-300`}>
          ...
          <div>
            ...
            <div className="space-y-2 max-h-60 overflow-y-auto pr-1">
              {slots.map(s => (
                ...
                >
                  <span className={`text-xs font-semibold font-mono ${slotText} transition-colors duration-300`}>{s}</span>
                  <button
                    onClick={() => removeSlot(s)}
