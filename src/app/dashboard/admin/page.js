  ...
  const vennColors = {
    patients:
      theme === "dark"
        ...
        : "border-blue-200 bg-blue-50/40 text-blue-500",
    ...
    <div className={`space-y-8 ${bgMain} transition-colors duration-300`}>
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between">
                <div>
                  <p
                    className={`text-xs font-semibold ${textMuted} uppercase tracking-wide transition-colors duration-300`}
                  >
                    {stat.label}
                  </p>
                  <p
                ...
                <div
                  className={`w-9 h-9 rounded-lg ${statsIconBg[color]} flex items-center justify-center flex-shrink-0 transition-colors duration-300`}
                >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          ...
          <p
            className={`text-xs ${textSecondary} mt-0.5 mb-6 transition-colors duration-300`}
          >
          ...
          <div className="h-72 w-full">
            ...
            analytics.performanceData.length > 0 ? (
              ...
              <div
                className={`flex justify-center items-center h-full text-xs ${textSecondary} italic transition-colors duration-300`}
              >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <div>
            ...
            <p
              className={`text-xs ${textSecondary} mt-0.5 mb-4 transition-colors duration-300`}
            >
              ...
              {analytics.specialtyData &&
                analytics.specialtyData.map((entry, index) => (
                  ...
                  >
                    ...
                    />
                    <span
                      className={`font-semibold ${textPrimary} truncate max-w-[120px] transition-colors duration-300`}
                    >
                      {entry.name}
                    </span>
                    <span
                      className={`${textMuted} transition-colors duration-300`}
                    >
                      ({entry.value})
                    </span>
                  </div>
        ...
        {/* Right: Venn Diagram */}
        <div
          className={`${bgCard} border ${cardBorder} rounded-xl p-6 flex flex-col justify-between h-full transition-colors duration-300`}
        >
          <div>
            <h2
              className={`text-base font-semibold ${textPrimary} transition-colors duration-300`}
          ...
          <div className="relative flex justify-center items-center h-48 mt-4">
            ...
            <div
              className={`absolute left-[15%] sm:left-[22%] w-36 h-36 rounded-full border ${vennColors.patients} flex flex-col justify-center items-center p-3 text-center transition-all hover:scale-105 shadow-sm`}
            >
              <span
                className={`text-[10px] uppercase tracking-wider font-semibold ${vennColors.patients} transition-colors duration-300`}
              >
                Patients
              </span>
              <span
                className={`text-2xl font-bold ${vennColors.patientsText} mt-1 transition-colors duration-300`}
              >
            ...
            <div
              className={`absolute right-[15%] sm:right-[22%] w-36 h-36 rounded-full border ${vennColors.clinicians} flex flex-col justify-center items-center p-3 text-center transition-all hover:scale-105 shadow-sm`}
            >
              <span
                className={`text-[10px] uppercase tracking-wider font-semibold ${vennColors.clinicians} transition-colors duration-300`}
              >
                Clinicians
              </span>
              <span
                className={`text-2xl font-bold ${vennColors.cliniciansText} mt-1 transition-colors duration-300`}
              >
            ...
            <div
              className={`absolute z-10 w-24 h-24 rounded-full border ${vennColors.overlap} backdrop-blur-md flex flex-col justify-center items-center p-2 text-center shadow-md transition-all hover:scale-110`}
            >
              <span
                className={`text-[9px] uppercase tracking-wider font-bold ${vennColors.overlap} leading-tight transition-colors duration-300`}
              >
                Active
                <br />
                Bookers
              ...
              <span
                className={`text-xl font-extrabold ${vennColors.overlapText} mt-0.5 transition-colors duration-300`}
              >
                {analytics.activePatientCount}
              </span>
            </div>
          </div>

          <div
            className={`text-center text-[10px] ${textMuted} mt-2 transition-colors duration-300`}
          >
            Intersection shows patients who have completed or have active
            pending schedules with verified clinicians.
          </div>
        </div>
      </div>
    </div>
